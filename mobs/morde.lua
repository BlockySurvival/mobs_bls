-- heals, respanws as an near-immortal thing that follows you...
mobs:register_mob("bls_mobs:morde", {
    type = "monster",
    hp_max = 47,
    hp_min = 37,
    ...
    drops = {
        ...
        min = 2,
        max = 4,},
        {name = "bls_mobs:proud_soul_fragment",
        chance = 3,
        min = 1,
        max = 1,},
    },
    ...
    on_die = function(self)
        ...
        self.object:remove()
        minetest.add_entity(pos, "bls_mobs:mortick")
    end,
})

minetest.register_entity("bls_mobs:mortick", {
