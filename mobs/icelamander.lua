mobs:register_mob("bls_mobs:icelamander", {
    type = "monster",
    hp_max = 230,
    hp_min = 230,
    ...
    do_custom = function(self)
        bls_mobs.midas_ability(self, "caverealms:thin_ice", self.run_velocity,1, 3)
    end,
})


mobs:spawn_specific(
    "bls_mobs:icelamander",
