...
mobs:register_mob("bls_mobs:morvalar", {
    type = "monster",
    hp_max = 100,
    hp_min = 100,
...
mobs:register_mob("bls_mobs:morvalar6", {
    type = "monster",
    hp_max = 120,
    hp_min = 120,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
...
mobs:register_mob("bls_mobs:morvalar5", {
    type = "monster",
    hp_max = 130,
    hp_min = 130,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
...
mobs:register_mob("bls_mobs:morvalar4", {
    type = "monster",
    hp_max = 100,
    hp_min = 100,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
...
mobs:register_mob("bls_mobs:morvalar3", {
    type = "monster",
    hp_max = 120,
    hp_min = 120,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
...
mobs:register_mob("bls_mobs:morvalar2", {
    type = "monster",
    hp_max = 90,
    hp_min = 90,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
        ...
        if (os.time() - self.morvalar2_timer) > 1 then
            ...
            for _,obj in ipairs(objects) do
                if obj:get_luaentity() then
                    ...
                    if (name == "bls_mobs:mordain" or name == "bls_mobs:morde" or name == "bls_mobs:morgut" or name == "bls_mobs:morgre" or name == "bls_mobs:morlu" or name == "bls_mobs:morwa" or name == "bls_mobs:morvy") then
                        counter = counter + 1
                    end
                end
            end
...
mobs:register_mob("bls_mobs:morvalar1", {
    type = "monster",
    hp_max = 160,
    hp_min = 160,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
...
mobs:register_mob("bls_mobs:morvalar0", {
    type = "monster",
    hp_max = 100,
    hp_min = 100,
    collisionbox = {-0.4, -0.1, -0.4, 0.4, 1.8, 0.4},
    ...
    on_die = function(self)
        ...
        --minetest.add_entity(pos, "bls_mobs:morvalar3")
    end,
})

minetest.register_entity("bls_mobs:kamehameha_bad", {
