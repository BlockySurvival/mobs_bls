mobs:register_mob("bls_mobs:morvy", {
    type = "monster",
    hp_max = 39,
    hp_min = 21,
    ...
    drops = {
        ...
        min = 5,
        max = 7,},
        {name = "bls_mobs:envious_soul_fragment",
        chance = 3,
        min = 1,
        max = 1,},
    },
        ...
        if self.morvy_counter == 4 then
            ...
            if line_of_sight_water(self, p, s) == true then
                ...
                for _,obj in ipairs(objects) do
                    if (obj:get_luaentity() and ((obj:get_luaentity().name == "bls_mobs:morbat1") or (obj:get_luaentity().name == "bls_mobs:morbat2") or (obj:get_luaentity().name == "bls_mobs:morbat3"))) then
                        counter = counter + 1
                    end
                end
                ...
                then
                    ...
                    if which == 1 then
                        bat = "bls_mobs:morbat1"
                    elseif which == 2 then
                        bat = "bls_mobs:morbat2"
                    elseif which == 3 then
                        bat = "bls_mobs:morbat3"
                    end
                    if (bat=="bls_mobs:morbat3") then
                        pos1.y=pos1.y+1.5
                    end
...
mobs:register_mob("bls_mobs:morbat1", {
    type = "monster",
    hp_max = 15,
    hp_min = 13,
...
mobs:register_mob("bls_mobs:morbat2", {
    type = "monster",
    hp_max = 13,
    hp_min = 5,
    collisionbox = {-0.1, 0.2, -0.1, 0.1, 0.4, 0.1},
...
mobs:register_mob("bls_mobs:morbat3", {
    type = "monster",
    hp_max = 13,
    hp_min = 12,
    collisionbox = {-0.1, 0.2, -0.1, 0.1, 0.4, 0.1},
